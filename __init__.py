...
bl_info = {
    "name": "UnrealBastioniLAB",
    "author": "Manuel Bastioni, Calem Bendell",
    "version": (1, 6, 1),
    "blender": (2, 7, 9),
    "location": "View3D > Tools > UnrealBastioniLab",
    "description": "A complete lab for characters creation for Unreal Engine",
    "warning": "",
    'wiki_url': "http://www.github.com/calben/UnrealBastioniLab",
    "category": "Characters"}
